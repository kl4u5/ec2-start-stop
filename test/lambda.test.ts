          ...
          Instances: [
            {
              ...
              State: { Name: 'stopped' },
              Tags: [{ Key: TAG_NAMES.START_STOP_SCHEDULE, Value: 'test-schedule' }],
            },
          ],
        },
      ],
          ...
          Instances: [
            {
              ...
              State: { Name: 'stopped' },
              Tags: [{ Key: TAG_NAMES.START_STOP_SCHEDULE, Value: 'ny-schedule' }],
            },
          ],
        },
      ],
          ...
          Instances: [
            {
              ...
              State: { Name: 'stopped' },
              Tags: [{ Key: TAG_NAMES.START_STOP_SCHEDULE, Value: 'invalid-schedule' }],
            },
          ],
        },
      ],
